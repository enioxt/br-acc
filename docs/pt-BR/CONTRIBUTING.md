...
O repositório inclui scripts opcionais. O **Monitor do upstream BR-ACC** (TASK-013) roda 2x ao dia via GitHub Actions para acompanhar forks, PRs e issues do upstream e sugestões de roadmap; ver [scripts/README-egos_inteligencia-monitor.md](../../scripts/README-egos_inteligencia-monitor.md) para uso e variáveis de ambiente.
